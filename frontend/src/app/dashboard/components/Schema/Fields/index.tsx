        ...
        {fields.map((field: any) => (
          ...
          >
            <div className={cx("icon", field.type)}>
              ...
              {field.type === "String" && (
                <Icon title={t(field.type)} type="fas fa-font" />
              )}
              {field.type === "Text" && (
                <Icon title={t(field.type)} type="fas fa-quote-right" />
              )}
              {field.type === "Media" && (
                <Icon title={t(field.type)} type="fas fa-image" />
              )}
              {field.type === "Boolean" && (
                <Icon title={t(field.type)} type="fas fa-toggle-on" />
              )}
              {field.type === "Dropdown" && (
                <Icon title={t(field.type)} type="fas fa-caret-square-down" />
              )}
              {field.type === "Reference" && (
                <Icon title={t(field.type)} type="fas fa-link" />
              )}
            </div>
