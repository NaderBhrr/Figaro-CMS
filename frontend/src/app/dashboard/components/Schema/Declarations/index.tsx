        ...
        <ul>
          {declarations.map((field: any) => {
            const disableDropdown =
              field.declaration === "Dropdown" && enumerations.length === 0;
            const disableReference =
              field.declaration === "Reference" && models.length - 1 <= 1;
            ...
            if (disableReference) {
              disabledMessage = t(
                "You should have at least 2 models to create a Reference"
              );
            }
                ...
                <div>
                  ...
                  >
                    <i
                      ...
                      style={{
                        color:
                          disableDropdown || disableReference
                            ? "gray"
                            : field.color,
                      }}
                    />
