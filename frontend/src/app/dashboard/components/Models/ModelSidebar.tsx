...
const ModelSidebar: FC<iProps> = ({ app, router }): ReactElement => {
  ...
  const handleEnumerationModal = (): void =>
    setIsOpenEnumeration(!isOpenEnumeration);
    ...
    <>
      <CreateEnumerationModal
        ...
        options={{
          position: "top",
          height:
            router.language === "ja-JP" || router.language === "ar"
              ? "627px"
              : "610px",
          width: "600px",
        }}
      ...
      <StyledModelSidebar>
        ...
        <div className="modelsWrapper">
          {models.map((model: any) => {
            ...
            return (
              <div key={model.id}>
                {/* Why setting href by "as" property? */}
          ...
          {enumerations.map((enumeration: any) => {
            ...
            return (
              <div key={enumeration.id}>
                <Link href={ENUMERATION_LINK(router).as}>
