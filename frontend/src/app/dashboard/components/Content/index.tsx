...
const Content: FC<iProps> = ({ data, router }): ReactElement => {
  ...
  const [isPublishOrUnpublishModalOpen, setIsPublishOrUnpublishModalOpen] =
    useState(false);
        ...
        <StyledContent style={{ margin: "0 auto", width: "98%" }}>
          ...
          <div className="rows">
            <Table
              ...
              onUnpublish={(ids: any): void =>
                handleEntriesModal(ids, "unpublish")
              }
            />
          </div>
        </StyledContent>
